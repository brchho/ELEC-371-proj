...
namespace cam_aforge1
{
    class GUIElements
    {
        ...
        int circleX1 = 50;
        int circleY1 = 50;
        public int squareX1 = 250;
        public int squareY1 = 200;
        int speed = 5;
        bool cirDir = true;
        bool sqrDir = true;
        ...
        public void Run(int r, int G, int b, Bitmap img)
        {
            ...
            void stayontrack()
            {
                ...
                {
                    if (change_panel_color(img, 1) > range && change_panel_color(img, 2) > range && change_panel_color(img, 3) > range)
                    {
                        squareY1 = squareY1 + 2;
                        squareX1 = squareX1 - 2;
                        sqr.x1 = squareX1;
